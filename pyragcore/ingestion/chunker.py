...
class Chunker:
    ...
    def chunk(self, text: str, metadata: Dict[str, Any], size: int = 600, overlap: int = 150,
              max_tokens: Optional[int] = None, return_token_count: bool = False) -> List[Dict[str, Any]] | tuple[
        ...
        :return: A list of {"chunk": str, "metadatas": dict} entries, or a tuple of
            that list paired with a parallel list of per-chunk token counts if
            return_token_count=True
        :rtype: List[Dict[str, Any]] | tuple[List[Dict[str, Any]], List[int]]
        """
